...
Next.js DOC uses MDX under the hood. A powerful markup language!
...
If you want to highlight code in another language such as Ruby or Rust, you can enable it by adding the following in `Next.js-browser.js`.
