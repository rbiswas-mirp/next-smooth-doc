...
Thanks to Next.js theme shadowing, it is possible to override the `AppNav` component by creating a component in `src/Next.js-doc/components/AppNav.js`.
